...
package com.filesfm.android.data.sharing.shares.datasources.implementation
    ...
    override fun insertShare(
        ...
        executeRemoteOperation {
            shareService.insertShare(
                remoteFilePath,
                com.filesfm.android.lib.resources.shares.ShareType.fromValue(shareType.value)!!,
                shareWith,
                permissions,
                name,
                password,
