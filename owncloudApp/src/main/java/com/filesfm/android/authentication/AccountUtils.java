...
import com.filesfm.android.lib.common.accounts.AccountUtils.Constants;
import com.filesfm.android.lib.resources.status.OwnCloudVersion;
import timber.log.Timber;

import java.util.Locale;

import static com.filesfm.android.data.authentication.AuthenticationConstantsKt.SELECTED_ACCOUNT;
import static com.filesfm.android.lib.common.accounts.AccountUtils.Constants.OAUTH_SUPPORTED_TRUE;
        ...
        if (currentAccount != null) {
            ...
            if (currentAccountVersion == null) {
                ...
                for (Account account : ocAccounts) {
                    ...
                    username = com.filesfm.android.lib.common.accounts.AccountUtils.
                            getUsernameForAccount(account);
                    newAccountName = com.filesfm.android.lib.common.accounts.AccountUtils.
